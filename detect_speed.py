# python detect_speed.py --weights yolov7.pt --source test1.mp4 --view-img --nosave --no-trace
...
area1_pointA = (520, 210)
area1_pointB = (825, 220)
area1_pointC = (490, 250)
area1_pointD = (834, 248)
# area1_pointA = (490, 350)
# area1_pointB = (660, 350)
# area1_pointC = (430, 400)
# area1_pointD = (860, 400)

# start_area = [(560, 250), (760, 250), (760, 300), (560, 300)]
stop_area = [(550, 170), (810, 180), (822, 216), (520, 210)]
# stop_area = [(560, 350), (920, 350), (920, 400), (560, 400)]
# stop_area = [(490, 350), (830, 350), (860, 400), (430, 400)]
start_area = [(490, 250), (830, 250), (860, 300), (430, 300)]
...
def draw_boxes(img, bbox, identities=None, categories=None, names=None, offset=(0, 0)):
    for i, box in enumerate(bbox):
        ...
        in_on_start_area = cv2.pointPolygonTest(np.array(start_area, np.int32), (int(midpoint_x), int(midpoint_y)),
                                                False)
        ...
        if id in vehicles_entering:
            in_on_stop_area = cv2.pointPolygonTest(np.array(stop_area, np.int32), (int(midpoint_x), int(midpoint_y)),
                                                   False)
            ...
            if in_on_stop_area >= 0:
                ...
                cv2.rectangle(img, (x1, y1), (x2, y2), (0, 0, 255), 1)
                cv2.rectangle(img, (x1, y1 - 20), (x1 + w + 100, y1), (255, 144, 30), -1)
                cv2.putText(img, label + " " + "Speed " + str(int(a_speed_kh)) + " km/h", (x1, y1 - 5),
                            cv2.FONT_HERSHEY_SIMPLEX, 0.6,
                            [255, 255, 255], 1)

                # storing the images of all the vehicles overspeeding
                # overspeeding_vehicles_saved = set()
                # if a_speed_kh > 20:
                #     if counting not in overspeeding_vehicles_saved:
                #             overspeeding_vehicles_saved.add(counting)
                #             save_img_path = r'/home/golu/PycharmProjects/vehicleSpeedDetection/overspeed'
                #             cv2.imwrite(os.path.join(save_img_path, f"speeding_car_{counting}.jpg"), img)
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            cv2.putText(im0, 'Average Speed = ' + str(int(average_speed)) + ' km/h', (160, 620), font, fontScale, color,
